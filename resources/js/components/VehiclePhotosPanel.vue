        ...
        <template v-else>
            ...
            >
                ...
                <template #item="slotProps">
                    ...
                    <button type="button" class="main-photo" @click="openZoom(slotProps.item)">

                        <img :src="slotProps.item" :alt="label" />

                        <span v-if="isLocalUrl(slotProps.item)" class="local-badge-inline">مرفوعة محلياً</span>
                ...
                <template #thumbnail="slotProps">
                    ...
                    <div class="thumb-wrap">
                        ...
                        <img :src="slotProps.item" :alt="`${label} thumbnail`" class="thumb-strip" />

                        <span v-if="isLocalUrl(slotProps.item)" class="local-dot" title="مرفوعة محلياً" />
...
async function onFilesSelected(stageKey, event) {
    ...
    try {
        ...
        emit('updated', result.data?.vehicle ?? result.data);
